...
function submitVoice(file) {
    ...
    var additionalParams = {
        headers: {
            ...
            //'X-Api-Key': 'DKNnwzryEgMlNGz2Rz4T9O9iMWrBkOv3vJhIu6m5',
            'timeout': 600000
        }
    }
    // https://cors-anywhere.herokuapp.com/https://dzwptd01uf.execute-api.us-east-1.amazonaws.com/gamma/photos/hw3-photos-bucket-b2/ 
    var url = "https://ggakqfzix6.execute-api.us-east-1.amazonaws.com/dev/upload/awstranscribe-recordings/" + file_name
...
function submitPhoto(e) {
    ...
    var additionalParams = {
        headers: {
            'Access-Control-Allow-Origin': '*',
            'Content-Type': file.type,
            //'X-Api-Key': 'izuGVmpUSH2E8ijy1TYdx74Y12Tf4rgw8EPfNUxY',
            'x-amz-meta-content-type': 'image/jpeg' // Add this line
        }
    }
...
// });
    ...
    url = "https://photoscc3.s3.amazonaws.com/" + file.name
